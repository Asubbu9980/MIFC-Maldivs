...
const MIFCHorizontal = () => {
    ...
    const lifestyleCards = [
        { title: 'Retail', bgColor: 'white', color: colors.navy, subtitle: 'A vibrant destination to shop with world-class retail experiences' },
        { title: 'Dine', bgColor: 'white', color: colors.navy, subtitle: 'Dining options to suit all tastes with premium restaurants and cafes' },
        { title: 'Discover', bgColor: 'white', color: colors.navy, subtitle: 'A world of art, culture and innovation in one place' },
        { title: 'Unwind', bgColor: 'white', color: colors.navy, subtitle: 'Wellness and relaxation spaces for ultimate rejuvenation' },
        { title: 'Sports &', subtitle2: 'Recreation', bgColor: 'white', color: colors.navy, subtitle: 'State-of-the-art fitness and recreational facilities' },
        { title: 'Safaris', bgColor: 'white', color: colors.navy, subtitle: 'Explore the natural beauty of the Maldives' },
        { title: 'Snorkeling', bgColor: 'white', color: colors.navy, subtitle: 'Underwater adventures in crystal clear waters' },
        { title: 'Islands', bgColor: 'white', color: colors.navy, subtitle: 'Discover pristine island experiences' },
        { title: 'Offers', bgColor: colors.turquoise, color: 'white', desc: 'Exclusive deals and packages', special: true },
        { title: 'Events', bgColor: 'white', color: colors.navy, subtitle: 'Cultural events and entertainment programs' }
    ];
    ...
    // Calculate slides
    const maxSlides = isMobile ? lifestyleCards.length - 1 : Math.max(0, lifestyleCards.length - 4);
    const maxPropertySlides = isMobile ? propertiesData.length - 1 : Math.max(0, propertiesData.length - 2);
    ...
    const getTransformValue = () => {
        ...
        return `translateX(-${currentSlide * 310}px)`;
    };

    const getPropertyTransformValue = () => {
        if (isMobile) {
            return `translateX(-${propertySlide * 100}%)`;
        }
        return `translateX(-${propertySlide * 475}px)`;
    };
...
`}</style>
            ...
            >
                ...
                <section style={{ minWidth: '100vw', height: '100vh', background: 'white', display: 'flex', alignItems: 'center', padding: '80px 0', position: 'relative' }}>
    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto', width: '100%' }}>
        ...
        <div style={{ textAlign: 'center', marginTop: '50px' }}>
            <button style={{ padding: '14px 28px', background: 'transparent', color: colors.turquoise, border: `2px solid ${colors.turquoise}`, borderRadius: '30px', fontSize: '14px', fontWeight: 600, cursor: 'pointer', transition: 'all 0.3s ease' }}>See more articles</button>
                ...
                <section style={{ minWidth: '100vw', minHeight: 'auto', background: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '60px 20px' }}>
